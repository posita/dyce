...
See the ``[options.extras_require]`` section in [``setup.cfg``](https://github.com/posita/dyce/blob/v0.4.5/setup.cfg).
...
* Provide tests where feasible and appropriate.
  ...
  Unit tests live in [``tests``](https://github.com/posita/dyce/tree/v0.4.5/tests).
