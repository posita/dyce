...
class TestHSub:
    ...
    def test_histogram(self) -> None:
        ...
        # (1.0-0.5)=0.5, (1.0-1.5)=-0.5, (2.0-0.5)=1.5, (2.0-1.5)=0.5 → {0.5:2,-0.5:1,1.5:1}
...
class TestHFloordiv:
    ...
    def test_histogram(self) -> None:
        ...
        # 7//2=3, 7//3=2, 9//2=4, 9//3=3 → {3:2, 2:1, 4:1}
...
class TestHMod:
    ...
    def test_histogram(self) -> None:
        ...
        # 7%3=1, 7%4=3, 9%3=0, 9%4=1 → {1:2, 3:1, 0:1}
...
class TestHLshift:
    ...
    def test_histogram(self) -> None:
        ...
        # 1<<2=4, 1<<3=8, 2<<2=8, 2<<3=16 → {4:1, 8:2, 16:1}
...
class TestHRshift:
    ...
    def test_histogram(self) -> None:
        ...
        # 16>>2=4, 16>>3=2, 32>>2=8, 32>>3=4 → {4:2, 2:1, 8:1}
...
class TestHAnd:
    ...
    def test_histogram(self) -> None:
        ...
        # 5&3=1, 5&4=4, 6&3=2, 6&4=4 → {1:1, 4:2, 2:1}
